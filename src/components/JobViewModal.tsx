...
export default function JobViewModal({ job, companyConfig, onClose }: JobViewModalProps) {
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-2xl border border-slate-100 shadow-2xl max-w-4xl w-full my-8 overflow-hidden animate-slide-up cursor-default flex flex-col max-h-[90vh]"
