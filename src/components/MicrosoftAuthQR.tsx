...
// Pure JS SHA-1 and HMAC-SHA1 implementation for environments where window.crypto.subtle is unavailable
  ...
  try {
    ...
    if (typeof window !== 'undefined' && window.crypto && window.crypto.subtle) {
      try {
        ...
        sigBytes = hmacSha1(keyBytes, new Uint8Array(timeBuffer));
      }
    } else {
      sigBytes = hmacSha1(keyBytes, new Uint8Array(timeBuffer));
    }
